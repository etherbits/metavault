...
export function AddToCollectionDialog({
  ...
  return (
    ...
    >
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-[220] bg-[#18181B]/[0.86] backdrop-blur-[8px]" />
        <Dialog.Content className="-translate-x-1/2 -translate-y-1/2 fixed left-1/2 top-1/2 z-[230] flex max-h-[min(640px,calc(100vh-32px))] w-[calc(100vw-32px)] max-w-[520px] flex-col overflow-hidden rounded-[12px] border border-[#3F3F46] bg-[#18181B] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] outline-none">
          <div className="border-b border-[#27272A] p-6">
            <Dialog.Title className="text-[20px] font-semibold leading-6 text-[#FAFAFA]">
              Add to collections
            </Dialog.Title>

            <Dialog.Description className="mt-2 text-[14px] leading-5 text-[#A1A1AA]">
