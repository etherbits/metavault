...
// biome-ignore lint/style/useNodejsImportProtocol: Bun supports bare fs specifiers
import { existsSync } from "fs";
// biome-ignore lint/style/useNodejsImportProtocol: Bun supports bare fs specifiers
import { rm } from "fs/promises";
// biome-ignore lint/style/useNodejsImportProtocol: Bun supports bare path specifier
...
// biome-ignore lint/suspicious/noExplicitAny: return type varies by parsed value
...
function parseArgs(): Partial<BuildConfig> {
	// biome-ignore lint/suspicious/noExplicitAny: dynamic BuildConfig assembly requires any
