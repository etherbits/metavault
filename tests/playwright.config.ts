...
const webServerEnv = {
  ...
  METAVAULT_CATALOGUE_REFRESH_KEY: "catalogue-test-key",
  METAVAULT_CATALOGUE_AI_BASE_URL: `${sourceMockBaseUrl}/openai/v1`,
  METAVAULT_CATALOGUE_AI_API_KEY: "catalogue-test-ai-key",
  METAVAULT_CATALOGUE_ANILIST_TOP_N: "2",
  METAVAULT_CATALOGUE_TMDB_API_KEY: "tmdb-catalogue-key",
  METAVAULT_CATALOGUE_TMDB_TOP_N: "1",
  METAVAULT_CATALOGUE_IGDB_CLIENT_ID: "igdb-client",
  METAVAULT_CATALOGUE_IGDB_ACCESS_TOKEN: "igdb-token",
  METAVAULT_CATALOGUE_IGDB_TOP_N: "1",
  METAVAULT_CATALOGUE_OPEN_LIBRARY_TOP_N: "1",
  METAVAULT_CATALOGUE_REFRESH_WINDOW_MS: "0",
  METAVAULT_CATALOGUE_EMBEDDING_BATCH_SIZE: "2",
};
